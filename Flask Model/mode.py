...
# def make_prediction(time_study, num_courses):
...
#     features = np.array([[time_study, num_courses]])
#     return model.predict(features)


# time_study = 4.50
# num_courses = 3
# print(make_prediction(time_study, num_courses))